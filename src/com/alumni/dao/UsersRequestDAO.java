...
public class UsersRequestDAO {
	...
	public UserRequestBean usersInfo(int Tempid) /* fetching specific user data from database using tempID   */
	{
		...
		try
		{
			...
			PreparedStatement st=con.prepareStatement("Select * from tempuserdata  where tempUID=? and email_verify=?");
			st.setInt(1,Tempid);
			st.setInt(2,1);
	...
	public List<UserRequestBean> users(int i, int j, int k) throws ClassNotFoundException, SQLException /* Method to display List of all available users data in database name Tempuserdata  */
	{
		...
		//String s="SELECT  tempuserdata.tempUID, tempuserdata.enr_no, tempuserdata.f_name, tempuserdata.l_name,tempuserdata.gender,tempuserdata.dob,tempuserdata.email_Id,branch.Branch_Name,passout_year.Passout_yr FROM tempuserdata INNER JOIN branch ON  tempuserdata.b_Id = branch.b_Id INNER JOIN passout_year ON tempuserdata.p_id = passout_year.p_id AND tempuserdata.b_Id = branch.b_Id  and verify_flag=1";
		String cls="select tempuserdata.tempUID, tempuserdata.enr_no, tempuserdata.f_name, tempuserdata.l_name,tempuserdata.gender,tempuserdata.dob,tempuserdata.email_Id,branch.Branch_Name,passout_year.Passout_yr from tempuserdata,branch,passout_year,moderator modr,members mem where tempuserdata.b_Id = branch.b_Id and tempuserdata.p_id = passout_year.p_id and tempuserdata.email_verify=1 and tempuserdata.p_id=mem.p_Id and tempuserdata.b_id=mem.b_Id and modr.m_Id=mem.m_Id and modr.m_Id = "+i;		
		String branch = "select tempuserdata.tempUID, tempuserdata.enr_no, tempuserdata.f_name, tempuserdata.l_name,tempuserdata.gender,tempuserdata.dob,tempuserdata.email_Id,branch.Branch_Name,passout_year.Passout_yr from tempuserdata,branch,passout_year where tempuserdata.b_Id = branch.b_Id and tempuserdata.p_id = passout_year.p_id and tempuserdata.email_verify=1 and tempUID in(select tempUID from tempuserdata t where((t.p_id,t.b_id)  not in (select p_Id,b_Id from members m,moderator o where m.m_Id = o.m_Id)) and ((t.p_id)  not in (select p_Id from members m,moderator o where m.m_Id = o.m_Id)) and (t.b_id = "+j+"));";
		String passoutYr = "select tempuserdata.tempUID, tempuserdata.enr_no, tempuserdata.f_name, tempuserdata.l_name,tempuserdata.gender,tempuserdata.dob,tempuserdata.email_Id,branch.Branch_Name,passout_year.Passout_yr from tempuserdata,branch,passout_year where tempuserdata.b_Id = branch.b_Id and tempuserdata.p_id = passout_year.p_id and tempuserdata.email_verify=1 and tempUID in(select tempUID from tempuserdata t where((t.p_id,t.b_id) not in (select p_Id,b_Id from members m,moderator o where m.m_Id = o.m_Id ))	and ((t.b_id)  not in (select b_Id from members m,moderator o where m.m_Id = o.m_Id)) and (t.p_id = "+k+"))";
