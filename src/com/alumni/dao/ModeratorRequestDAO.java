...
public class ModeratorRequestDAO {
	...
	public List<ModeratorRequestBean> users() throws ClassNotFoundException, SQLException /* Method to display List of all available users data in database name Tempuserdata  */
	{
